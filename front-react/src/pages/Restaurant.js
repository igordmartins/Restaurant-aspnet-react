...
export class Restaurant extends Component{
    ...
    refreshList(){
        fetch(variables.API_URL+'restaurants')
    ...
    deleteClick(id){
        if(window.confirm('Are you sure?')){
            fetch(variables.API_URL+'restaurants/'+id,{
                method:'DELETE',
                headers:{
                    'Accept':'application/json',
                    'Content-Type':'application/json'
                    ...
                    <tbody>
                        {restaurants.map(rest=>
                            <tr key={rest.RestaurantId}>
                                ...
                                <td>{rest.RestaurantDescription}</td>
                                <td>
                                    <button type="button" 
                                    className="btn btn-light mr-1"
                                    data-bs-toggle='modal'
                                    data-bs-target='#exampleModal'
                                    onClick={()=>this.editClick(rest)}>
                                    ...
                                    <button type="button" 
                                    className="btn btn-light mr-1"
                                    onClick={()=>this.deleteClick(rest.RestaurantId)}>
